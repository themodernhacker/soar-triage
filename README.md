...
for every level 10+ alert, in about **0.7 s each** (0.55 to 1.1 s measured across
the run, versus ~2 min 50 s to do the same triage by hand). The disposition shows right in the labels: level-12
